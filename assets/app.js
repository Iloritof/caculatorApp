function initCalc() {
  ...
  displayInput.setAttribute('id', 'input-display');
  displayInput.setAttribute('name', 'input-display');
  ...
  buttonCreator(['btn--special', 'btn--history'], undefined, [
    'history',
    'svg--1',
    './assets/history.svg',
  ]);
  buttonCreator(['btn--special', 'btn--clear'], 'AC', undefined);
  buttonCreator(['btn--special', 'btn--backspace'], undefined, [
    'backspace',
    'svg',
    './assets/backspace.svg',
  ]);
  buttonCreator(
    ['btn--special', 'btn--operator', 'btn--equal'],
    '=',
    undefined
  );
...
calc.addEventListener('keypress', (e) => {
  if (clearScreen) {
    inputField.value = '';
    clearScreen = false;
  }
  ...
  if (
    ...
    displayOperator.textContent = e.key;
    if (e.key === 'Enter') {
      displayOperator.textContent = '=';
    }
    if (e.key !== 'Enter') {
